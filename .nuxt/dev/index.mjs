globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://D:/Web%20Dev%20Work/Nuxt%203%20Projects/calorie-counter/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file://D:/Web%20Dev%20Work/Nuxt%203%20Projects/calorie-counter/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, assertMethod, readBody, setCookie, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError } from 'file://D:/Web%20Dev%20Work/Nuxt%203%20Projects/calorie-counter/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file://D:/Web%20Dev%20Work/Nuxt%203%20Projects/calorie-counter/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file://D:/Web%20Dev%20Work/Nuxt%203%20Projects/calorie-counter/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file://D:/Web%20Dev%20Work/Nuxt%203%20Projects/calorie-counter/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file://D:/Web%20Dev%20Work/Nuxt%203%20Projects/calorie-counter/node_modules/ofetch/dist/node.mjs';
import destr from 'file://D:/Web%20Dev%20Work/Nuxt%203%20Projects/calorie-counter/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://D:/Web%20Dev%20Work/Nuxt%203%20Projects/calorie-counter/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://D:/Web%20Dev%20Work/Nuxt%203%20Projects/calorie-counter/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file://D:/Web%20Dev%20Work/Nuxt%203%20Projects/calorie-counter/node_modules/scule/dist/index.mjs';
import { klona } from 'file://D:/Web%20Dev%20Work/Nuxt%203%20Projects/calorie-counter/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://D:/Web%20Dev%20Work/Nuxt%203%20Projects/calorie-counter/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://D:/Web%20Dev%20Work/Nuxt%203%20Projects/calorie-counter/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file://D:/Web%20Dev%20Work/Nuxt%203%20Projects/calorie-counter/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://D:/Web%20Dev%20Work/Nuxt%203%20Projects/calorie-counter/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/Web%20Dev%20Work/Nuxt%203%20Projects/calorie-counter/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/Web%20Dev%20Work/Nuxt%203%20Projects/calorie-counter/node_modules/radix3/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "supabase": {
      "url": "https://ireisqgccdxqnxfhxguj.supabase.co",
      "key": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImlyZWlzcWdjY2R4cW54Zmh4Z3VqIiwicm9sZSI6ImFub24iLCJpYXQiOjE2NzkyMzA1MDQsImV4cCI6MTk5NDgwNjUwNH0.s-jzBDQoSkEVyEktT1Af5Od49jQHc3ZjdvgZlEblrpY",
      "client": {},
      "redirect": false,
      "cookies": {
        "name": "sb",
...
const serverAssets = [{"baseName":"server","dir":"D:/Web Dev Work/Nuxt 3 Projects/calorie-counter/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\Web Dev Work\\Nuxt 3 Projects\\calorie-counter","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\Web Dev Work\\Nuxt 3 Projects\\calorie-counter\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\Web Dev Work\\Nuxt 3 Projects\\calorie-counter\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\Web Dev Work\\Nuxt 3 Projects\\calorie-counter\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lqAsZZ = defineEventHandler(async (event) => {
...
const _lazy_fnttfK = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_fnttfK, lazy: true, middleware: false, method: undefined },
  { route: '/api/_supabase/session', handler: _lqAsZZ, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_fnttfK, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://D:/Web%20Dev%20Work/Nuxt%203%20Projects/calorie-counter/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('file://D:/Web%20Dev%20Work/Nuxt%203%20Projects/calorie-counter/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
...
const _virtual__headStatic = {"headTags":"<meta charset=\"utf-8\">\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\n<link rel=\"stylesheet\" href=\"https://fonts.googleapis.com/icon?family=Material+Icons+Outlined\">\n<link rel=\"stylesheet\" type=\"text/css\" href=\"https://cdnjs.cloudflare.com/ajax/libs/bulma/0.9.2/css/bulma.min.css\">","bodyTags":"","bodyTagsOpen":"","htmlAttrs":"","bodyAttrs":""};
